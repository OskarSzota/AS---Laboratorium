		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="#">{$page_title|default:"Lista zawierająca dane osobowe"}</a></li>
					...
					<li><a class="btn" href="{$conf->action_url}personList">LISTA</a></li>
	...
	<header id="head">
		<div class="container">
			<div class="row">
				...
				<p class="tagline">{$page_description|default:"Lista zawierająca dane osobowe"}</p>
