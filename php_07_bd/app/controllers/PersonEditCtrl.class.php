...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		$this->form->address = getFromRequest('address',true,'Błędne wywołanie aplikacji');
		...
		if (empty(trim($this->form->address))) {
			getMessages()->addError('Wprowadź miejsce zamieszkania');
		}
	...
	public function action_personEdit(){
		...
		if ( $this->validateEdit() ){
			try {
				...
				$this->form->birthdate = $record['address'];
