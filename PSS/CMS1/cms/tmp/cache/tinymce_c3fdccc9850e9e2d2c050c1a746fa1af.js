...
tinymce.init({
	...
	cmsms_tiny: cmsms_tiny = {
			...
			linker_image : 'http://localhost/cms/modules/TinyMCE/lib/images/cmsmslink.gif',
			linker_url : 'http://localhost/cms/admin/moduleinterface.php?mact=TinyMCE,m1_,linker,0&__c=fe008672fb522b870c0&showtemplate=false',
			linker_autocomplete_url : 'http://localhost/cms/admin/moduleinterface.php?mact=TinyMCE,m1_,ajax_getpages,0&__c=fe008672fb522b870c0&showtemplate=false',
	...
	autoresize_bottom_margin: 10,
			...
			external_filemanager_path:"http://localhost/cms/modules/TinyMCE/responsive_filemanager/filemanager/",
	  	filemanager_title: "File manager",
		filemanager_access_key: "f2fe41a7790f70c18bca2fb196c71197",
	...
	external_plugins: {
					"cmsms_linker" : "http://localhost/cms/modules/TinyMCE/lib/js/tinymce_external_plugins/cmsms_linker/plugin.js",
							"filemanager" : "http://localhost/cms/modules/TinyMCE/responsive_filemanager/filemanager/plugin.min.js",
			"responsivefilemanager" : "http://localhost/cms/modules/TinyMCE/responsive_filemanager/tinymce_plugin/responsivefilemanager/plugin.min.js",
			},
