...
define('DEFAULT_GALLERY_PATH', 'Gallery');
define('DEFAULT_GALLERYTHUMBS_PATH', 'GalleryThumbs');
...
tinymce.create('tinymce.plugins.picker', {
  ...
  function GetHeaderHTML() {
    $tmpl = <<<EOT
<link rel="stylesheet" type="text/css" href="{$this->GetModuleURLPath()}/lib/jquery/jquery-ui.smoothness.css" media="screen" /> <!-- smoothness/jquery-ui-1.8.12.custom.css -->
<link rel="stylesheet" type="text/css" href="{$this->GetModuleURLPath()}/lib/jquery/jquery.treeTable.css" media="screen" />
<link rel="stylesheet" type="text/css" href="{$this->GetModuleURLPath()}/lib/imgareaselect/imgareaselect-animated.css" media="screen" />

<script type="text/javascript">
	$.event.props = $.event.props.join('|').replace('layerX|layerY|', '').split('|');
</script>
<script type="text/javascript" src="{$this->GetModuleURLPath()}/lib/jquery/jquery.tablednd.js"></script>
<script type="text/javascript" src="{$this->GetModuleURLPath()}/lib/jquery/jquery.treeTable.js"></script>
<script type="text/javascript" src="{$this->GetModuleURLPath()}/lib/imgareaselect/jquery.imgareaselect.min.js"></script>
<script type="text/javascript" src="{$this->GetModuleURLPath()}/lib/galleryadminscripts.js"></script>
EOT;
    return $tmpl;
  }
